...
const REVERIE_SOUNDS = {
  ...
  click:
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663172862422/wZRvtQdggXUqzbVa.mp3",
  match:
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663172862422/cTHWPpSKHBtsDFnp.mp3",
  error:
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663172862422/slYSlpxjllEbxLNc.mp3",
  victory:
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663172862422/ZLDNwNWOXRzfpHTy.mp3",
};
...
class SoundManager {
  ...
  play(key) {
    ...
    if (this.sounds[key]) {
      ...
      this.sounds[key]
        .play()
        .catch((e) => console.log("Audio play blocked by browser. Interaction required."));
    }
  }
