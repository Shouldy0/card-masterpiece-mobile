...
const MISSIONS: Mission[] = [
  ...
  {
    id: "start1",
    name: "Risveglio: Vinci 1 partita",
    progress: 0,
    target: 1,
    reward: 50,
    icon: Sparkles,
  ...
  {
    id: "spend6",
    name: "Maestro del Focus: Spendi 6 in un turno",
    progress: 0,
    target: 1,
    reward: 250,
    icon: Zap,
  ...
  {
    id: "ranked5",
    name: "Scalata: Vinci 5 partite Ranked",
    progress: 2,
    target: 5,
    reward: 500,
    icon: Crown,
  ...
  return (
    <MobileFrame>
        ...
        <div className="mt-2 overflow-hidden rounded-xl gold-frame">
          <div className="relative h-32 bg-gradient-to-br from-mystic via-rose/40 to-abyss p-4">
            ...
            <div className="relative mt-4 flex items-end justify-between">
              ...
              <button className="rounded-full gold-frame bg-mystic/40 px-3 py-1 text-[10px] uppercase tracking-widest">
                Vedi
              </button>
            </div>
          </div>
            ...
            return (
              <div key={m.id} className="rounded-xl gold-frame bg-card/60 p-3">
                <div className="flex items-center gap-3">
                  <div className="flex size-9 items-center justify-center rounded-lg bg-mystic/30 ring-1 ring-gold/40">
                  ...
                  >
                    {done ? <Check className="h-3 w-3" /> : <Coins className="h-3 w-3" />}{" "}
                    {m.reward}
                  </button>
                </div>
              </div>
      ...
      <div className="mt-5 px-4">
        ...
        <div className="mt-2 space-y-2">
          {[
            { name: "Incubi della Notte", at: "Inizia tra: 1g 5h", icon: Sparkles },
            { name: "Specchi Rotti", at: "Inizia tra: 5g 2h", icon: Calendar },
          ].map((e) => {
            const Icon = e.icon;
            return (
              <div
                key={e.name}
                className="flex items-center gap-3 rounded-xl gold-frame bg-card/60 p-3"
              >
                <div className="flex size-10 items-center justify-center rounded-lg bg-mystic/30 ring-1 ring-gold/40">
      ...
      <Link
        to="/news"
        className="mx-4 mt-5 mb-24 block rounded-xl gold-frame bg-card/60 p-3 text-center text-[10px] uppercase tracking-widest text-muted-foreground"
      >
        Vedi Notizie & Manutenzione →
      </Link>
