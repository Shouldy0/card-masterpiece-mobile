...
import { ArrowLeft, BarChart3, History, Library, Award, Settings as SettingsIcon, Eye, ChevronRight } from "lucide-react";
  ...
  return (
    <MobileFrame>
      <header className="flex items-center gap-2 px-4 pt-6">
        ...
        <h1 className="flex-1 text-center font-display text-lg gold-text tracking-widest">PROFILO</h1>
        <Link to="/settings" className="flex size-9 items-center justify-center rounded-full bg-card/60 ring-1 ring-gold/30"><SettingsIcon className="h-4 w-4 text-gold" /></Link>
      </header>
      ...
      <div className="mt-6 flex items-center gap-3 px-4">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-[10px] uppercase tracking-widest text-gold">Livello {player.level}</p>
      ...
      <Link to="/ranked" className="mx-4 mt-4 flex items-center justify-between rounded-xl gold-frame bg-card/60 p-3">
        <div>
          <p className="text-[9px] uppercase tracking-widest text-muted-foreground">Rango Attuale</p>
      ...
      <div className="mx-4 mt-4 grid grid-cols-2 gap-2">
        <Link to="/stats" className="flex items-center gap-2 rounded-xl gold-frame bg-card/60 p-3"><BarChart3 className="h-5 w-5 text-gold" /><span className="text-xs">Statistiche</span></Link>
        <Link to="/history" className="flex items-center gap-2 rounded-xl gold-frame bg-card/60 p-3"><History className="h-5 w-5 text-gold" /><span className="text-xs">Cronologia</span></Link>
        <Link to="/deck" className="flex items-center gap-2 rounded-xl gold-frame bg-card/60 p-3"><Library className="h-5 w-5 text-gold" /><span className="text-xs">Mazzi</span></Link>
        <Link to="/titles" className="flex items-center gap-2 rounded-xl gold-frame bg-card/60 p-3"><Award className="h-5 w-5 text-gold" /><span className="text-xs">Titoli</span></Link>
      </div>
