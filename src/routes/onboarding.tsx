...
const slides = [
  {
    icon: Sparkles,
    title: "Benvenuto nel tuo Sogno",
    body: "Reverie è un duello tra coscienze. Controlla i territori della mente.",
  },
  {
    icon: Hand,
    title: "Gioca le Carte",
    body: "Usa il Focus per evocare Archetipi, Ricordi e Maschere.",
  },
  {
    icon: Crown,
    title: "Conquista i Territori",
    body: "Controlla i territori e sconfiggi la coscienza avversaria.",
  },
];
    ...
    <MobileFrame className="px-6 pb-10 pt-12">
      ...
      <div className="mb-6 flex justify-center gap-2">
        {slides.map((_, idx) => (
          <span
            key={idx}
            className={`h-1.5 w-6 rounded-full transition-all ${idx === i ? "bg-gold" : "bg-mystic/40"}`}
          />
        ))}
      </div>
