...
export const CARDS: CardDef[] = [
  ...
  { id: "v1_ambizione", name: "Ambizione", type: "archetipo", cost: 5, power: 8, rarity: "leggendaria", text: "+2 Potere a se stessa.", flavor: "Voglio tutto, anche se il prezzo è la mia anima.", effect: { kind: "buff_self", amount: 2 }, art: "/abisso_interiore_art_naked_1778156612010.png" },
  ...
  { id: "v3_nostalgia", name: "Nostalgia", type: "archetipo", cost: 2, power: 3, rarity: "rara", text: "Pesca 1 carta.", flavor: "Un passato che brilla più del presente.", effect: { kind: "draw", amount: 1 }, art: "/eco_dimenticato_art_naked_1778156187502.png" },
  ...
  { id: "v5_follia", name: "Follia", type: "archetipo", cost: 6, power: 10, rarity: "leggendaria", text: "+3 Potere.", flavor: "La verità è un cerchio che non si chiude mai.", effect: { kind: "buff_self", amount: 3 }, art: "/risveglio_se_art_naked_1778156326534.png" },
  { id: "v6_empatia", name: "Empatia", type: "archetipo", cost: 2, power: 2, rarity: "rara", text: "Cura 2 HP.", flavor: "Sento il tuo peso come se fosse il mio.", effect: { kind: "heal", amount: 2 }, art: "/catarsi_art_naked_1778156397123.png" },
  { id: "v7_rancore", name: "Rancore", type: "archetipo", cost: 4, power: 5, rarity: "rara", text: "Debuff -1 globale.", flavor: "Un fuoco che brucia senza mai spegnersi.", effect: { kind: "weaken_enemy", amount: 1 }, art: "/dolore_represso_art_naked_1778156785342.png" },
  ...
  { id: "v9_coraggio", name: "Coraggio", type: "archetipo", cost: 3, power: 4, rarity: "comune", text: "Senza paura.", flavor: "L'ultimo baluardo prima del buio assoluto.", effect: { kind: "none" }, art: "/luce_interiore_art_naked_1778156465529.png" },
  { id: "v10_armonia", name: "Armonia", type: "archetipo", cost: 3, power: 3, rarity: "rara", text: "Cura 2 HP.", flavor: "Il silenzio perfetto tra due battiti del cuore.", effect: { kind: "heal", amount: 2 }, art: "/catarsi_art_naked_1778156397123.png" },
  ...
  { id: "c1_giullare", name: "Il Giullare", type: "maschera", cost: 2, power: 3, rarity: "comune", text: "Ridere per non urlare.", flavor: "Il pubblico non deve mai vedere la lacrima sotto il trucco.", effect: { kind: "none" }, art: "/io_falso_art_naked_1778156881158.png" },
  ...
  { id: "c3_vittima", name: "La Vittima", type: "maschera", cost: 3, power: 4, rarity: "rara", text: "Cura 1 HP.", flavor: "Il dolore è l'unica cosa che mi fa sentire ancora vivo.", effect: { kind: "heal", amount: 1 }, art: "/maschera_dolore_art_naked_1778156708847.png" },
  ...
  { id: "b1_vuoto", name: "Il Vuoto", type: "oblio", cost: 4, power: 5, rarity: "rara", text: "Annulla effetti.", flavor: "Non c'è nulla qui, nemmeno il dolore.", effect: { kind: "none" }, art: "/abisso_interiore_art_naked_1778156612010.png" },
  ...
  { id: "s1_miraggio", name: "Miraggio", type: "sogno", cost: 2, power: 2, rarity: "comune", text: "Illusione ottica.", flavor: "Bello da vedere, impossibile da toccare.", effect: { kind: "none" }, art: "/io_falso_art_naked_1778156881158.png" },
  { id: "s2_aurora", name: "Aurora", type: "sogno", cost: 3, power: 4, rarity: "rara", text: "Luce nascente.", flavor: "La promessa di un risveglio che non arriva mai.", effect: { kind: "none" }, art: "/luce_interiore_art_naked_1778156465529.png" },
  { id: "s3_nuvola", name: "Nuvola di Sogni", type: "sogno", cost: 2, power: 3, rarity: "comune", text: "Leggerezza.", flavor: "Fluttuare sopra l'abisso del reale.", effect: { kind: "none" }, art: "/catarsi_art_naked_1778156397123.png" },
  { id: "s4_visione", name: "Visione Eterea", type: "sogno", cost: 5, power: 7, rarity: "epica", text: "Pesca 2 carte.", flavor: "Vedere attraverso il velo del tempo.", effect: { kind: "draw", amount: 2 }, art: "/risveglio_se_art_naked_1778156326534.png" },
  { id: "s5_stella", name: "Stella Cadente", type: "sogno", cost: 1, power: 2, rarity: "comune", text: "Un desiderio.", flavor: "Brilla intensamente prima di spegnersi per sempre.", effect: { kind: "none" }, art: "/luce_interiore_art_naked_1778156465529.png" },
  { id: "s6_labirinto", name: "Il Labirinto", type: "sogno", cost: 4, power: 5, rarity: "rara", text: "Perso nel sogno.", flavor: "Non c'è uscita quando non vuoi essere trovato.", effect: { kind: "none" }, art: "/specchio_distorto_art_naked_1778157085995.png" },
